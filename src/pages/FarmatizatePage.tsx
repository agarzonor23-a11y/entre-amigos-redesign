...
const FarmatizatePage = () => (
  <AllyPageTemplate
    ...
    heroImage={heroImg}
    heroImageAlt="Droguista colombiano en su farmacia"
    note="*Cada crédito tiene condiciones y beneficios diferentes según tu perfil de riesgo."
    solicitudLink="https://www.entreamigos.co/microcredito-farmatizate"
    ...
    products={[
      {
        ...
        link: "https://www.entreamigos.co/microcredito-farmatizate",
      },
      {
        ...
        amount: "Montos de hasta $2.000.000",
        link: "https://www.entreamigos.co/impulsacredito-farmatizate",
      },
    ]}
    features={[
