    ...
    <footer className="bg-teal-dark py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="flex gap-6 mb-14">
          <a href="https://www.facebook.com/entreamigosSAS" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Facebook" className="text-primary-foreground/60 hover:text-secondary transition-colors">
          ...
          <a href="https://www.instagram.com/entreamigos_sas/" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Instagram" className="text-primary-foreground/60 hover:text-secondary transition-colors">
          ...
          <a href="https://www.youtube.com/@entreamigossas" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en YouTube" className="text-primary-foreground/60 hover:text-secondary transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>
          </a>
          <a href="https://www.linkedin.com/company/entreamigos-sas/" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en LinkedIn" className="text-primary-foreground/60 hover:text-secondary transition-colors">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/60">
              ...
              <li><a href="/negocio-amigo" onClick={handleNav("/negocio-amigo")} className="hover:text-secondary transition-colors font-semibold text-secondary">Negocio Amigo</a></li>
